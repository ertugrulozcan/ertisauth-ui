...
const DateTimeValidationFields = (props: FieldInfoValidationProps<DateTimeFieldInfo>) => {
	...
	const onChange: RangePickerProps['onChange'] = (dates, dateStrings) => {
		...
		let updatedFieldInfo: DateTimeFieldInfo | null = null
		if (props.payload) {
...
export default DateTimeValidationFields;