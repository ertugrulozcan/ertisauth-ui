...
import BottomPanel from "../layouts/panels/BottomPanel"
import { ReduxStore } from "../../redux/ReduxStore"
import { Switch, Listbox, Transition } from '@headlessui/react'
import { CheckIcon, SelectorIcon } from '@heroicons/react/solid'

type DiffViewerPanelPros = {
	originalContent: any
	changedContent: any
	isVisible: boolean
	onCloseRequest?(): void
...
const DiffViewerPanel: React.FC<DiffViewerPanelPros> = ({originalContent, changedContent, isVisible, onCloseRequest}) => {
	...
	const [themeStyles, setThemeStyles] = useState<any>(style(state.theme.value === "dark"));
	...
	React.useEffect(() => {
		...
		setThemeStyles(style(useDarkTheme))
	}, [useDarkTheme])
	...
	return (
		<BottomPanel title="Diff Viewer" isVisible={isVisible} onCloseRequest={onCloseRequest} scrollable={true}>
			<BottomPanel.Toolbox>
