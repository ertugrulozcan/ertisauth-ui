...
export class FloatFieldValidator implements IFieldInfoValidator<FloatFieldInfo, number> {
	validateFieldInfo(fieldInfo: FloatFieldInfo): FieldValidationResult[] {
	...
	validateFieldInfoSchema(fieldInfo: FloatFieldInfo): FieldValidationResult[] {
		const validationResults: FieldValidationResult[] = []
		return validationResults
	}

	validateValue(fieldInfo: FloatFieldInfo, value: number, bypassRequiredValueValidation?: boolean): FieldValidationResult[] {
		const validationResults: FieldValidationResult[] = []
